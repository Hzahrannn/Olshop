...
<head>
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="container-fluid"> 
			<h4>SILAHKAN MENGISI FORM UNTUK MELANJUTKAN TRANSAKSI</h4><br>
                <div class="row">
			...
			require_once( "db.php");
			$id= $_GET['id'];
					$sql = "SELECT * FROM barang WHERE id LIKE '%$id%'";
					$result = $db->query($sql);
					$cek = $result->fetch_array();
?>
						<div class="form-group mb-3">
                                                
                                                <input type="hidden" name="nama_barang" value="<?php echo $cek["nama"]; ?>" class="form-control">
                                            </div>
											<div class="form-group mb-3">
...
?>" class="form-control">
                        ...
                        <div class="form-group mb-3">
                                                ...
                                                <input type="text" name="jmlh" class="form-control">
                                            </div>
						
                    
                                    
                       <button type="submit" class="btn btn-warning waves-effect waves-light" name="beli">Pesan Sekarang!</button>
